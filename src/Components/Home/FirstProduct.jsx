...
export const FirstProduct = () => {
  return (
    <div className="h-auto lg:h-[90vh] w-full p-6 m-20 bg-background flex flex-col lg:flex-row">
      <section className="flex flex-col h-full items-center justify-center p-10 space-y-8 w-full lg:w-[40%] bg-french-grey rounded-2xl ">
    ...
    <motion.section
      className="h-full w-full lg:w-[60%] relative overflow-visible"
